...
def test_read_nonexistent_course():
    ...
    response = client.get("/courses/CS-0000")  # Fix the route to API as required
...
def test_create_course():
    ...
    data = {"id": "CS-1234", "name": "test", "instructor": "test", "keyword": []}
...
def test_create_existing_course():
    ...
    data = {"id": "CS-E4190", "name": "test", "instructor": "test"}
    response = client.post(
        "/courses/", json=data
    )  # Fix the route to API and data as required
